...
const texts = [
    ...
    },
    {
        ...
        url: 'https://improvisedchef.com/',
        github: 'https://github.com/joelprat/Improvised_chef',
        img: i0
    },
    {
        title: 'TeacherBot',
        description: 'TeacherBot is a project made with 3 other UAB students. It consists of a robot capable of reading text in Catalan, written by hand, and then crossing out misspellings. For its operation it has been necessary to develop the logic of the inverse kinematics and a server that processes the requests in Python, an Android application in Java for the connection between the robot and the server and finally the Arduino code to be able to execute instructions.',
